<nav x-data="{ open: false }" class="border-b border-white">
    ...
    <div class="flex-grow ">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center content-start mr-10 ml-5 imagenNav">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @if(Auth::user()->role == 'developer')
                                ...
                                <x-dropdown-link :href="route('games.mygames')">
                                    {{ __('Mis juegos') }}
                                </x-dropdown-link>
                            @endif
                            <x-dropdown-link :href="route('games.myrentedgames')">
                                {{ __('Mis juegos alquilados') }}
                            </x-dropdown-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            @if(Auth::check())
                ...
                <div class="mt-3 space-y-1">
                    ...
                    @endif
                    @if(Auth::user()->role == 'developer')
                        <x-responsive-nav-link :href="route('games.create')">
                            {{ __('Añadir juego') }}
                        </x-responsive-nav-link>
                        <x-responsive-nav-link :href="route('games.mygames')">
                            {{ __('Mis juegos') }}
                        </x-responsive-nav-link>
                    @endif

                    <x-responsive-nav-link :href="route('games.myrentedgames')">
                        {{ __('Mis juegos alquilados') }}
                    </x-responsive-nav-link>
                    <div class="mt-3 space-y-1">
